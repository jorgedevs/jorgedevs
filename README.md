...
Over the years, I have honed my skills in building pixel-perfect, robust and scalable desktop applications.<br><br>

<img src="assets/pump-screens.png" style="margin: 10px 20px;">

Building intricate layouts using XAML and overall app architecture using MVVM ensure best practices for maintainable and testable code.<br><br>

<img src="assets/meadow-samples.png" style="margin: 10px 20px;">

Built an extensive collection of easy-to-follow samples and tutorials to the most advanced IoT .NET platform in the market.<br><br>

<img src="assets/cultivar-screen.png" style="margin: 10px 20px;">

My keen eye for detail drives me to build high-quality applications that provide a seamless user experience.<br><br>
